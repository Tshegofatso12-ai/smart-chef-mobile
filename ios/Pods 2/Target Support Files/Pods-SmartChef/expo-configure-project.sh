...
with_node \
  ...
  --target "/Users/tshegofatsomaseko/Documents/GitHub/smart-chef-mobile/ios/Pods/Target Support Files/Pods-SmartChef/ExpoModulesProvider.swift" \
  --entitlement "/Users/tshegofatsomaseko/Documents/GitHub/smart-chef-mobile/ios/SmartChef/SmartChef.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-asset" "expo-blur" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image-picker" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-secure-store" "expo-speech-recognition" "expo-splash-screen" "expo-system-ui"
